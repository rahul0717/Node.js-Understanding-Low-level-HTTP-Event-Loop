//The Imports and the global vaibles
...
//************This creation of server is only for testing purpose **************
//*********** You can uncomment this can can access this API's using a get and post plugin in chrome********/
    ...
    if (Object.keys(newStory).length == 0) {
        ...
        fs.readFile(filePath, fileOptions, function (err, data) {
            if (err) {
                ...
                existingStoryData = JSON.stringify(existingStoryData)
    ...
    if (Object.keys(contentData).length == 0) {
        ...
        fs.readFile(filePath, fileOptions, function (err, data) {
            if (err) {
                ...
                console.log("update  story content started");
                storyData = JSON.parse(data);
                for (var story of storyData) {
